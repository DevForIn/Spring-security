...
import com.kblife.reviewuserservice.util.JwtUtil;
...
public class SecurityConfig {
    ...
    public AuthenticationSuccessHandler successHandler(JwtUtil jwtUtil){
        return new CustomizeAuthenticationSuccessHandler(jwtUtil);
    }
    ...
    protected SecurityFilterChain configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .addFilterAfter(customAuthenticationFilter, UsernamePasswordAuthenticationFilter.class); // 커스텀 필터 추가
